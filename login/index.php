...
<body>
    ...
    <main class="cflex">
        ...
        <!-- SECTION -->
        <section class="flex form" id="login_section">

            <form action="<?= $auth_login_php_url ?>" class="cflex authenticate" id="login_form" method="POST">
                ...
                <input class="input_field" id="input_email" name="user_email" autocomplete="email" placeholder="Enter your email address" type="email" required>

                <label class="input_title" for="input_password">
                    Password
                </label>
                <input class="input_field" id="input_password" name="user_password" autocomplete="new-password" placeholder="Enter your password" type="password" required>
                ...
                <a class="authenticate_other" href="<?= $nav_register_url ?>">
                    Register instead
                </a>
                <a href="#login"></a>
